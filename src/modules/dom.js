    ...
    const dom = /*html*/ `
        <div id="todoTask" class="flex flex-row justify-between w-full bg-primary rounded-md p-2" data-projectindex="${projectIndex}" data-taskindex="${taskIndex}">
          ...
          <div id="actionButtons" class="flex flex-col gap-2">
            <label for="popup" id="todoDelete" class="btn btn-xs btn-ghost" data-projectindex="${projectIndex}" data-taskindex="${taskIndex}">
            ...
            <label for="popup" id="editTaskButton" class="btn btn-xs btn-ghost" data-projectindex="${projectIndex}" data-taskindex="${taskIndex}">
